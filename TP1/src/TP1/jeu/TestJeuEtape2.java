...
//        Nain nains1 = new Nain();
//        Elfe elfe1 = new Elfe();
//        Elfe elfe2 = new Elfe();
//        ChateauUtilitaire.afficheDonneeChateau(chateauRouge);
//
//        chateauRouge.ajoutGuerrierNovice(elfe1);
//        chateauRouge.ajoutGuerrierNovice(nains1);
...
////        ChateauUtilitaire.afficheGuerrierNovice(chateauRouge.listeGuerrierNovice);
//
//        // A COMPLETER : Réaliser un premier entrainement puis afficher les guerriers prets aux combats
//        chateauRouge.entrainer();
//        ChateauUtilitaire.afficheGuerrierEntrainer(chateauRouge.listeGuerrierEntrainer);
////        ChateauUtilitaire.afficheGuerrierNovice(chateauRouge.listeGuerrierNovice);
//        ChateauUtilitaire.afficheDonneeChateau(chateauRouge);
//        System.out.println(elfe2.getRessourceEntrainement());
//
//
